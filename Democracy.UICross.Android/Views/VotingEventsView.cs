...
{
    [Activity(
        Label = "@string/Voting Events",
        ScreenOrientation = ScreenOrientation.Portrait)]
    public class VotingEventsView : MvxAppCompatActivity<VotingEventsViewModel>
    {
        private readonly string[] menuOptions = { "Voting Event Details", "Edit User", "Change Password", "Close Session" };
        ...
        private void listView_ItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            {
                case 0:
                    StartActivity(typeof(VotingEventDetailView));
                    break;
                case 1:
